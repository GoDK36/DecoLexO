...
def First_Syllable(df, a, b, c, original_index):
    ...
    original_df_list = []
    for i in range(len(original_df)):
        original_df_list.append(original_df.loc[i,'Lemma'])
            ...
            if b == '.':
                ...
                if c == '*':
                    if word[2] != ' ':
                        ...
                        original_index.append(original_df_list.index(lemma[i]))
                        cnt += 1
                elif c == '.':
                    if word[2] == ' ':
                        indexlis.append(lemma.index(lemma[i]))
...
class Ui_Deco_LexO(object):
    ...
    def filter_function(self):
        ...
        if self.FLemma_Input.text () != '':
            ...
            if statelis[0] == 1:
                handle_df = Equals (handle_df, 'Lemma', self.FLemma_Input.text (),original_index)

            if statelis[0] == 2:
                handle_df = Starts_With (handle_df, 'Lemma', self.FLemma_Input.text (),original_index)

            if statelis[0] == 3:
                handle_df = Ends_With (handle_df, 'Lemma', self.FLemma_Input.text(),original_index)

            if statelis[0] == 4:
                handle_df = Contains (handle_df, 'Lemma', self.FLemma_Input.text(),original_index)

            if statelis[0] == 5:
                handle_df = Is_Empty (handle_df, 'Lemma', self.FLemma_Input.text(),original_index)
        ...
        if self.FEntry_Input.text () != '':
            ...
            if statelis[0] == 1:
                handle_df = Equals (handle_df, 'Entry', self.FEntry_Input.text (),original_index)

            if statelis[0] == 2:
                handle_df = Starts_With (handle_df, 'Entry', self.FEntry_Input.text (),original_index)

            if statelis[0] == 3:
                handle_df = Ends_With (handle_df, 'Entry', self.FEntry_Input.text(),original_index)

            if statelis[0] == 4:
                handle_df = Contains (handle_df, 'Entry', self.FEntry_Input.text(),original_index)

            if statelis[0] == 5:
                handle_df = Is_Empty (handle_df, 'Entry', self.FEntry_Input.text(),original_index)
        ...
        if self.FCate_Input.text () != '':
            ...
            if statelis[0] == 1:
                handle_df = Equals (handle_df, 'Category', self.FCate_Input.text (),original_index)

            if statelis[0] == 2:
                handle_df = Starts_With (handle_df, 'Category', self.FCate_Input.text (),original_index)

            if statelis[0] == 3:
                handle_df = Ends_With (handle_df, 'Category', self.FCate_Input.text(),original_index)

            if statelis[0] == 4:
                handle_df = Contains (handle_df, 'Category', self.FCate_Input.text(),original_index)

            if statelis[0] == 5:
                handle_df = Is_Empty (handle_df, 'Category', self.FCate_Input.text(),original_index)
        ...
        if self.FInfo_Input.text () != '':
            ...
            if self.FInfo_Colname.text() != '':
                if statelis[0] == 1:
                    handle_df = Equals (handle_df, self.FInfo_Colname.text(), self.FInfo_Input.text (),original_index)

                if statelis[0] == 2:
                    handle_df = Starts_With (handle_df, self.FInfo_Colname.text(), self.FInfo_Input.text (),original_index)

                if statelis[0] == 3:
                    handle_df = Ends_With (handle_df, self.FInfo_Colname.text(), self.FInfo_Input.text(),original_index)

                if statelis[0] == 4:
                    handle_df = Contains (handle_df, self.FInfo_Colname.text(), self.FInfo_Input.text(),original_index)

                if statelis[0] == 5:
                    handle_df = Is_Empty (handle_df, self.FInfo_Colname.text(), self.FInfo_Input.text(),original_index)
        ...
        if self.FFirst_1.text() != '' or self.FFirst_2.text() != '' or self.FFirst_3.text() != '':
            handle_df = First_Syllable(handle_df, self.FFirst_1.text(), self.FFirst_2.text(), self.FFirst_3.text(),original_index)
        ...
        if self.FSec_1.text() != '' or self.FSec_2.text() != '' or self.FSec_3.text() != '':
            handle_df = Second_Syllable(handle_df, self.FSec_1.text(), self.FSec_2.text(), self.FSec_3.text(),original_index)
        ...
        if self.FSecL_1.text() != '' or self.FSecL_2.text() != '' or self.FSecL_3.text() != '':
            handle_df = Second_to_Last_Syllable(handle_df, self.FSecL_1.text(), self.FSecL_2.text(), self.FSecL_3.text(),original_index)
        ...
        if self.FLast_1.text() != '' or self.FLast_2.text() != '' or self.FLast_3.text() != '':
            handle_df = Last_Syllable(handle_df, self.FLast_1.text(), self.FLast_2.text(), self.FLast_3.text(),original_index)
        ...
        print('handle_df_list의 정보\n', handle_df_list[self.dataFrame_Tab.currentIndex() -1 ])
    ...
    def show_all(self):
        ...
        try:
            ...
            filtered_df = original_df_list[self.dataFrame_Tab.currentIndex()-1].copy()

            for y in range(len(handle_df)):
                filtered_df.iloc[original_index[y], :] = handle_df.iloc[y, :]
            ...
            handle_df_list[self.dataFrame_Tab.currentIndex()-1] = filtered_df
